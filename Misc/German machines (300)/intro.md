...
I have a machine which I used to create this challenge. <br>
...
The first 2 initials are `"J"` and `"Q"` (I forgot the last one) and I haven't touched the initials of the rings. <br>
